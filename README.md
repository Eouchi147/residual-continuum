...
| Living Earth | 49 turning points over 4.5 billion years: climate, animals, plants, the planet and humans side by side, a live globe that changes era by era, four gauges (temperature, CO2, oxygen, sea level) with uncertainty, and the Earth's one-day clock |
